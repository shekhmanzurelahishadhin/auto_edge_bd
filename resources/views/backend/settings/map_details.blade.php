            ...
            <div class="card">
                <div class="card-header">
                    <div class="row align-items-center">
                        <div class="col-md-6">
                            <h4 class="card-title mb-0">Add New Map Details</h4>
                        </div>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.map-details.store') }}" method="post" id="newForm" enctype="multipart/form-data" >
                        @csrf
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="new-user-info">
                                            ...
                                            <div class="row">
                                                <div class="mb-3">
                                                    <label for="map_details">{{ __('Map Details') }}: <strong
                                                            class="text-danger">*</strong></label>
                                                    <textarea id="map_details" type="text"
                                                              class="form-control @error('map_details') is-invalid @enderror"
                                                              name="map_details" required>{{$map_details??null}}</textarea>
                                                    @error('map_details')
    ...
    <script>
        ...
        $().ready(function() {
            var validator = $("#newForm").validate({
                ...
                messages: {
                    map_details: {
                        required: 'Map Details is required'
                    }
                }
            });
            ...
            $('#map_details').summernote({
                placeholder: 'Write Map Details',
                tabsize: 2,
                height: 180
            });
        });
