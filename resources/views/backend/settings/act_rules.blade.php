            ...
            <div class="card">
                <div class="card-header">
                    <div class="row align-items-center">
                        <div class="col-md-6">
                            <h4 class="card-title mb-0">Add New Act & Rules</h4>
                        </div>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.act-rule.store') }}" method="post" id="newForm" enctype="multipart/form-data" >
                        @csrf
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="new-user-info">
                                            ...
                                            <div class="row">
                                                <div class="mb-3">
                                                    <label for="attachment">Act & Rules Attachment <strong class="text-danger">* <small>(JPG,JPEG,PNG,PDF only | Max: 150 MB)</small></strong></label>
                                                    <input class="file-upload dropify" name="attachment" id="attachment" type="file" data-allowed-file-extensions="jpg jpeg png pdf" required data-default-file="{{ $attachment != null ? asset($attachment) : '' }}">
                                                    @error('attachment')
