                ...
                <div class="card-header">
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-6 text-end">
                            @can('year.create')
                                <a href="{{ route('admin.year.create') }}" class="btn btn-primary">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end" style="">
                                                    ...
                                                    @can('year.destroy')
                                                        <li>
                                                            ...
                                                            <form id="delete-form-{{ $data->id }}"
                                                                  action="{{ route('admin.year.destroy', $data->id) }}"
                                                        ...
                                                        <li>
                                                            <a class="dropdown-item edit-item-btn"
                                                               href="{{ route('admin.year.restore', $data->id) }}">
                                                ...
                                                @else
                                                    ...
                                                    @can('year.edit')
                                                        <li>
                                                            <a class="dropdown-item edit-item-btn"
                                                               href="{{ route('admin.year.edit', $data->id) }}">
                                                    ...
                                                    @can('year.destroy')
                                                        <li>
                                                            ...
                                                            <form id="trash-form-{{ $data->id }}"
                                                                  action="{{ route('admin.year.trash', $data->id) }}"
                                                                  method="POST" style="display: none;">
                                                                @csrf
                                                            </form>
                                                        </li>
