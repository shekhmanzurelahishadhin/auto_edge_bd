            ...
            <div class="card">
                <div class="card-header">
                    <div class="row align-items-center">
                        <div class="col-md-6">
                            <h4 class="card-title mb-0">Edit Vehicle Year</h4>
                        </div>
                        <div class="col-md-6 text-end">
                            @can('year.index')
                                <a href="{{ route('admin.year.index') }}" class="btn dark-icon btn-danger"><i
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.year.update',$year->id) }}" method="post" id="newForm" enctype="multipart/form-data" >
                        @csrf
                        @method('put')
                        <div class="row">
                            <div class="col-md-12">
                                        ...
                                        <div class="new-user-info">
                                            <div class="row">
                                                <div class="mb-3 col-md-12">
                                                    <label for="title">{{ __('Vehicle Year Title') }}: <strong
                                                            class="text-danger">*</strong></label>
                                                    <input id="title" type="text"  class="form-control @error('title') is-invalid @enderror" value="{{ $year->title }}" name="title" required>
                                                    @error('title')
                                                ...
                                                <div class="mb-3 py-4">
                                                    ...
                                                    <div class="pretty p-icon p-round p-pulse">
                                                        <input type="radio" id="active"  name="status" value="1" {{$year->status=='1'?'checked':''}} />
                                                    ...
                                                    <div class="pretty p-icon p-round p-pulse">
                                                        <input type="radio" id="inactive"   name="status" value="0" {{$year->status=='0'?'checked':''}}/>
