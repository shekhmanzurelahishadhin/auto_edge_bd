        ...
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.vehicle.update',$vehicle->id) }}" method="post" id="newForm" enctype="multipart/form-data" >
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-md-8">
                                                ...
                                                <div class="mb-3 col-md-6">
                                                    ...
                                                    <select name="brand_id" id="brand_id"
                                                        ...
                                                        @forelse($brands as $data)
                                                            <option value="{{ $data->id }}" {{$vehicle->brand_id==$data->id?'selected':''}}>{{ $data->title }}</option>
                                                        @empty
                                                        @endforelse
                                                    </select>
                                                    @error('brand_id')
                                                ...
                                                <div class="mb-3 col-md-6">
                                                    ...
                                                    <select name="model_id" id="model_id"
                                                        ...
                                                        @forelse($models as $data)
                                                            <option value="{{ $data->id }}" {{$vehicle->model_id==$data->id?'selected':''}}>{{ $data->title }}</option>
                                                        @empty
                                                        @endforelse
                                                    </select>
                                                    @error('model_id')
                                                ...
                                                <div class="mb-3 col-md-6">
                                                    ...
                                                    <select name="year_id" id="year_id"
                                                        ...
                                                        @forelse($years as $data)
                                                            <option value="{{ $data->id }}" {{$vehicle->year_id==$data->id?'selected':''}}>{{ $data->title }}</option>
                                                        @empty
                                                        @endforelse
                                                    </select>
                                                    @error('year_id')
                                                ...
                                                <div class="mb-3 col-md-6">
                                                    ...
                                                    <select name="fuel_type_id" id="fuel_type_id"
                                                        ...
                                                        @forelse($fuel_types as $data)
                                                            <option value="{{ $data->id }}" {{$vehicle->fuel_type_id==$data->id?'selected':''}}>{{ $data->title }}</option>
                                                        @empty
                                                        @endforelse
                                                    </select>
                                                    @error('fuel_type_id')
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea class="form-control @error('short_description') is-invalid @enderror"  name="short_description" id="short_description"  required>{{ $vehicle->short_description??'' }}</textarea>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea class="form-control @error('description') is-invalid @enderror"  name="description" id="description"  required>{{ $vehicle->description??'' }}</textarea>
                                                        @error('description')
                                                        <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                    </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="mb-3">
                                            ...
                                            <input class="file-upload dropify" name="image" id="image" type="file" data-default-file="{{ asset($vehicle->main_image) }}">
                                            @error('image')
                                            <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="mb-3 py-4">
                                            ...
                                            <div class="pretty p-icon p-round p-pulse">
                                                <input type="radio" id="active"  name="status" value="1" {{$vehicle->status=='1'?'checked':''}} />
                                            ...
                                            <div class="pretty p-icon p-round p-pulse">
                                                <input type="radio" id="inactive"   name="status" value="0" {{$vehicle->status=='0'?'checked':''}}/>
