                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-6 text-end">
                            @can('office-achievement.create')
                                <a href="{{ route('admin.office-achievement.create',$id) }}" class="btn btn-primary">
                                    ...
                                    <td class="text-center w-10">
                                        <div class="dropdown d-inline-block">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end" style="">
                                                ...
                                                @if($data->deleted_at)
                                                    @can('office-achievement.destroy')
                                                        <li>
                                                            ...
                                                            <form id="delete-form-{{ $data->id }}"
                                                                  action="{{ route('admin.office-achievement.destroy', $data->id) }}"
                                                        ...
                                                        <li>
                                                            <a class="dropdown-item edit-item-btn"
                                                               href="{{ route('admin.office-achievement.restore', $data->id) }}">
                                                ...
                                                @else
                                                    @can('office-achievement.index')
                                                        <li>
                                                            <a class="dropdown-item edit-item-btn"
                                                               href="{{ route('admin.office-achievement.show', $data->id) }}">
                                                                <i class="bx bxs-show align-bottom me-2 text-muted"></i>
                                                                Show
                                                            </a>
                                                        </li>
                                                    @endcan
                                                    @can('office-achievement.edit')
                                                        <li>
                                                            <a class="dropdown-item edit-item-btn"
                                                               href="{{ route('admin.office-achievement.edit', $data->id) }}">
                                                    ...
                                                    @can('office-achievement.destroy')
                                                        <li>
                                                            ...
                                                            <form id="trash-form-{{ $data->id }}"
                                                                  action="{{ route('admin.office-achievement.trash', $data->id) }}"
                                                                  method="POST" style="display: none;">
                                                                @csrf
                                                            </form>
                                                        </li>
