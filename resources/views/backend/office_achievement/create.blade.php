        ...
        <div class="col-lg-12">
            <div class="card">
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-6 text-end">
                            @can('office-achievement.index')
                                <a href="{{ route('admin.office-achievement.index',$id) }}" class="btn dark-icon btn-danger"><i
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.office-achievement.store') }}" method="post" id="newForm" enctype="multipart/form-data" >
                        @csrf
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card">
                                        ...
                                        <div class="new-user-info">
                                            <div class="row">
                                                <div class="mb-3 col-md-12">
                                                    <label for="title">{{ __('Gallery/Achievement Title') }}: <strong
                                            ...
                                            <div class="row">
                                                <div class="mb-3">
                                                    <label for="image">Gallery/Achievement Image <strong class="text-danger">* <small>(Recommended Size 1920 X 1080 | Max: 50 MB)</small></strong></label>
