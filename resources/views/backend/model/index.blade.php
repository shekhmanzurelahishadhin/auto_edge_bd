                ...
                <div class="card-header">
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-6 text-end">
                            @can('model.create')
                                <a href="{{ route('admin.model.create') }}" class="btn btn-primary">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end" style="">
                                                    ...
                                                    @can('model.destroy')
                                                        <li>
                                                            ...
                                                            <form id="delete-form-{{ $data->id }}"
                                                                  action="{{ route('admin.model.destroy', $data->id) }}"
                                                        ...
                                                        <li>
                                                            <a class="dropdown-item edit-item-btn"
                                                               href="{{ route('admin.model.restore', $data->id) }}">
                                                ...
                                                @else
                                                    @can('model.index')
                                                        <li>
                                                            <a class="dropdown-item edit-item-btn"
                                                               href="{{ route('admin.model.show', $data->id) }}">
                                                    ...
                                                    @can('model.edit')
                                                        <li>
                                                            <a class="dropdown-item edit-item-btn"
                                                               href="{{ route('admin.model.edit', $data->id) }}">
                                                    ...
                                                    @can('model.destroy')
                                                        <li>
                                                            ...
                                                            <form id="trash-form-{{ $data->id }}"
                                                                  action="{{ route('admin.model.trash', $data->id) }}"
                                                                  method="POST" style="display: none;">
                                                                @csrf
                                                            </form>
                                                        </li>
