                        ...
                        <table id="buttons-datatables" class="display table table-bordered dataTable no-footer"
                            ...
                            @forelse ($slider as $data)
                                <tr>
                                    ...
                                    <td><img src="{{asset($data->image)}}" width="200" height="100" alt=""></td>
                                    @if( Auth::guard('admin')->user()->type =='super_admin')
                                        <td>
                                            @if($data->department !=null)
                                                <span class="badge rounded-pill badge-soft-info">{{ $data->department->name }}</span>
                                            @elseif($data->institute !=null)
                                                <span class="badge rounded-pill badge-soft-secondary">{{ $data->institute->name }}</span>
                                            @elseif($data->office !=null)
                                                <span class="badge rounded-pill badge-soft-primary">{{ $data->office->name }}</span>
                                            @else
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end" style="">
                                                    ...
                                                    @can('slider.destroy')
                                                        <li>
                                                            ...
                                                            <form id="delete-form-{{ $data->id }}"
                                                                  action="{{ route('admin.slider.destroy', $data->id) }}"
                                                        ...
                                                        <li>
                                                            <a class="dropdown-item edit-item-btn"
                                                               href="{{ route('admin.slider.restore', $data->id) }}">
                                                ...
                                                @else
                                                    @can('slider.index')
                                                        <li>
                                                            <a class="dropdown-item edit-item-btn"
                                                               href="{{ route('admin.slider.show', $data->id) }}">
                                                    ...
                                                    @can('slider.destroy')
                                                        <li>
                                                            ...
                                                            <form id="trash-form-{{ $data->id }}"
                                                                  action="{{ route('admin.slider.trash', $data->id) }}"
                                                                  method="POST" style="display: none;">
                                                                @csrf
                                                            </form>
                                                        </li>
