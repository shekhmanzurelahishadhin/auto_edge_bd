                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-6 text-end">
                            @can('office-project.create')
                                <a href="{{ route('admin.office-project.create',$id) }}" class="btn btn-primary">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end" style="">
                                                    ...
                                                    @can('office-project.destroy')
                                                        <li>
                                                            ...
                                                            <form id="delete-form-{{ $data->id }}"
                                                                  action="{{ route('admin.office-project.destroy', $data->id) }}"
                                                        ...
                                                        <li>
                                                            <a class="dropdown-item edit-item-btn"
                                                               href="{{ route('admin.office-project.restore', $data->id) }}">
                                                ...
                                                @else
                                                    @can('office-project.index')
                                                        <li>
                                                            <a class="dropdown-item edit-item-btn"
                                                               href="{{ route('admin.office-project.show', $data->id) }}">
                                                                <i class="bx bxs-show align-bottom me-2 text-muted"></i>
                                                                Show
                                                            </a>
                                                        </li>
                                                    @endcan
                                                    @can('office-project.edit')
                                                        <li>
                                                            <a class="dropdown-item edit-item-btn"
                                                               href="{{ route('admin.office-project.edit', $data->id) }}">
                                                    ...
                                                    @can('office-project.destroy')
                                                        <li>
                                                            ...
                                                            <form id="trash-form-{{ $data->id }}"
                                                                  action="{{ route('admin.office-project.trash', $data->id) }}"
                                                                  method="POST" style="display: none;">
                                                                @csrf
                                                            </form>
                                                        </li>
