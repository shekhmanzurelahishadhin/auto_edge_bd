            ...
            <div class="card">
                <div class="card-header">
                    <div class="row align-items-center">
                        <div class="col-md-6">
                            <h4 class="card-title mb-0">Edit Journal</h4>
                        </div>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.journal.update',$journal->id) }}" method="post" id="newForm" enctype="multipart/form-data" >
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-md-8">
                                        ...
                                        <div class="new-user-info">
                                            <div class="row">
                                                <div class="mb-3 col-md-12">
                                                    ...
                                                    <input id="title" type="text"  class="form-control @error('title') is-invalid @enderror"  value="{{$journal->title}}" name="title" required>
                                                    @error('title')
                                                ...
                                                <div class="mb-3 col-md-12">
                                                    <label for="title">{{ __('Publishing Authority') }}: <strong
                                                            class="text-danger">*</strong></label>
                                                    <input id="title" type="text"  class="form-control @error('publishing_authority') is-invalid @enderror"  value="{{ $journal->publishing_authority }}" name="publishing_authority" required>
                                                ...
                                                <div class="mb-3 col-md-12">
                                                    <label for="title">{{ __('Editor') }}: <strong
                                                            class="text-danger">*</strong></label>
                                                    <input id="title" type="text"  class="form-control @error('editor') is-invalid @enderror"  value="{{ $journal->editor }}" name="editor" required>
                                                    @error('editor')
                                                    <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                                </div>
                                                <div class="mb-3 col-md-12">
                                                    <label for="title">{{ __('Associate Editor') }}: <strong
                                                            class="text-danger">*</strong></label>
                                                    <input id="title" type="text"  class="form-control @error('associate_editor') is-invalid @enderror"  value="{{ $journal->associate_editor }}" name="associate_editor" required>
                                            ...
                                            <div class="col-12">
                                                <div class="mb-3">
                                                    <label for="description">{{ __('Description') }}: <strong
                                                            class="text-danger">*</strong></label>
                                                    <textarea id="description" class="form-control @error('description') is-invalid @enderror"  name="description" required>{{ $journal->description }}</textarea>
                                                    @error('description')
                                                    <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                                </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="mb-3">
                                            ...
                                            <input class="file-upload dropify" name="image" id="image" type="file" data-allowed-file-extensions="jpg jpeg png"
                                                   data-default-file="{{ $journal->image != null ? asset($journal->image) : '' }}">
                                            @error('image')
                                            <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                        <div class="mb-3">
                                            ...
                                            <input id="published_at" type="text" placeholder="YYYY-MM-DD" class="form-control @error('published_at') is-invalid @enderror"
                                                   data-date-format="Y-m-d"    value="{{ $journal->published_at }}" name="published_at" required>
                                            @error('published_at')
                                            <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                        <div class="mb-3 py-4">
                                            ...
                                            <div class="pretty p-icon p-round p-pulse">
                                                <input type="radio" id="active"  name="status" value="1" {{$journal->status=='1'?'checked':''}} />
                                            ...
                                            <div class="pretty p-icon p-round p-pulse">
                                                <input type="radio" id="inactive"   name="status" value="0" {{$journal->status=='0'?'checked':''}}/>
