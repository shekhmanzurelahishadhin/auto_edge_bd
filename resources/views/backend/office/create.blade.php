            ...
            <div class="card">
                <div class="card-header">
                    <div class="row align-items-center">
                        <div class="col-md-6">
                            <h4 class="card-title mb-0">New Office Create</h4>
                        </div>
                ...
                <div class="card-body">
                    <form action="{{ route('admin.office.store') }}" method="post" enctype="multipart/form-data" id="officeForm">
                        @csrf
                        <div class="row justify-content-center">
                            <div class="col-md-8">
                                ...
                                <div class="my-4">
                                    ...
                                    @foreach (App\Enums\OfficeType::cases() as $officeType)
                                        <div class="form-check form-check-inline form-radio-outline form-radio-primary mb-3">
                                            <input class="form-check-input" type="radio" name="type" id="{{$officeType->value}}" value="{{ $officeType->value }}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea type="text" class="form-control summernote" rows="3" style="height: 200px;" name="about" id="about">{{ old('about') }}</textarea>
                                    @error('about')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="row">
                                    <div class="mb-3 col-md-12">
                                        ...
                                        <textarea required name="mission" id="mission" rows="5"
                                                  class="summernote form-control @error('mission') is-invalid @enderror">{{ old('mission') }}</textarea>
                                        @error('mission')
                                ...
                                <div class="row">
                                    <div class="mb-3 col-md-12">
                                        <label for="vision">{{ __('Vision') }}: <strong class="text-danger">*</strong></label>
                                        <textarea required name="vision" id="vision" rows="5"
                                                  class="summernote form-control @error('vision') is-invalid @enderror">{{ old('vision') }}</textarea>
                                        @error('vision')
                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    <label for="image">Office Image: <br> <strong class="text-danger"><small>(Recommended Size 1920 X 1080 | Max: 50 MB)</small></strong></label>
                                    <input type="file" class="form-control dropify" name="image" id="image" data-allowed-file-extensions="jpg jpeg png webp"
                                           value="{{ old('image') }}" >
                                    @error('image')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                ...
                                <div class="mb-3">
                                    <label for="contact">Contact Information: <strong class="text-danger">*</strong></label>
                                    <textarea type="text" class="form-control" rows="4" name="contact" id="contact">{{ old('contact') }}</textarea>
                                    @error('contact')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
