            ...
            <div class="">
                <div class="card-header">
                    <div class="row align-items-center">
                        <div class="col-md-6">
                            <h4 class="card-title mb-0">Edit Auction Sheet</h4>
                        </div>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.auction-sheet.update',$auction_sheet->id) }}" method="post" id="newForm" enctype="multipart/form-data" >
                        @csrf
                        @method('put')
                        <div class="row">
                            <div class="col-md-12">
                                        ...
                                        <div class="new-user-info">
                                            <div class="row">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="title" id="title" value="{{$auction_sheet->title??old('title')}}" required>
                                                    @error('title')
                                            ...
                                            <div class="row">
                                                <div class="mb-3">
                                                    ...
                                                    <input class="file-upload dropify" name="image" type="file"
                                                           ...
                                                           data-default-file="{{ $auction_sheet->image != null ? asset($auction_sheet->image) : '' }}">
                                                    @error('image')
                                            ...
                                            <div class="mb-3 py-4">
                                                ...
                                                <div class="pretty p-icon p-round p-pulse">
                                                    <input type="radio" id="active"  name="status" value="1" {{$auction_sheet->status=='1'?'checked':''}} />
                                                ...
                                                <div class="pretty p-icon p-round p-pulse">
                                                    <input type="radio" id="inactive"   name="status" value="0" {{$auction_sheet->status=='0'?'checked':''}}/>
