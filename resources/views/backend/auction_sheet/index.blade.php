                ...
                <div class="card-header">
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-6 text-end">
                            @can('auction-sheet.create')
                                <a href="{{ route('admin.auction-sheet.create') }}" class="btn btn-primary">
                ...
                <div class="card-body">
                    <div id="buttons-datatables_wrapper" class="dataTables_wrapper dt-bootstrap5 no-footer">
                        <table id="buttons-datatables" class="display table table-bordered dataTable no-footer"
                            ...
                            <tbody>
                            @forelse ($auction_sheets as $data)
                                <tr>
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end" style="">
                                                    ...
                                                    @can('auction-sheet.destroy')
                                                        <li>
                                                            ...
                                                            <form id="delete-form-{{ $data->id }}"
                                                                  action="{{ route('admin.auction-sheet.destroy', $data->id) }}"
                                                        ...
                                                        <li>
                                                            <a class="dropdown-item edit-item-btn"
                                                               href="{{ route('admin.auction-sheet.restore', $data->id) }}">
                                                ...
                                                @else
                                                    @can('auction-sheet.index')
                                                        <li>
                                                            <a class="dropdown-item edit-item-btn"
                                                               href="{{ route('admin.auction-sheet.show', $data->id) }}">
                                                                <i class="bx bxs-show align-bottom me-2 text-muted"></i>
                                                                Show
                                                            </a>
                                                        </li>
                                                    @endcan
                                                    @can('auction-sheet.edit')
                                                        <li>
                                                            <a class="dropdown-item edit-item-btn"
                                                               href="{{ route('admin.auction-sheet.edit', $data->id) }}">
                                                    ...
                                                    @can('auction-sheet.destroy')
                                                        <li>
                                                            ...
                                                            <form id="trash-form-{{ $data->id }}"
                                                                  action="{{ route('admin.auction-sheet.trash', $data->id) }}"
                                                                  method="POST" style="display: none;">
                                                                @csrf
                                                            </form>
                                                        </li>
