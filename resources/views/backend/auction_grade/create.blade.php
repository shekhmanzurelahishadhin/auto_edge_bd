        ...
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.auction-grade.store') }}" method="post" id="newForm" enctype="multipart/form-data" >
                        @csrf
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card">
                                        ...
                                        <div class="new-user-info">
                                            <div class="row">
                                                ...
                                                <div class="mb-3 col-md-12">
                                                    ...
                                                    <select name="auction_category_id" id="auction_category_id" class="form-control form-control-lg select2" required>
                                                        ...
                                                        @forelse($auction_categories as $auction_category)
                                                            <option value="{{ $auction_category->id }}">{{ $auction_category->title }}</option>
                                                        @empty
                                                        @endforelse
                                                    </select>
                                                ...
                                                <div class="mb-3 col-md-12">
                                                    ...
                                                    <input id="grade" type="text"  class="form-control @error('grade') is-invalid @enderror"  value="{{ old('grade') }}" name="grade" required>
                                                    @error('grade')
                                                    <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="mb-3 col-md-12">
                                                    <label for="grade_details">{{ __('Auction Grade Details') }}: <strong
                                                            class="text-danger">*</strong></label>
                                                    <input id="grade_details" type="text"  class="form-control @error('grade_details') is-invalid @enderror"  value="{{ old('grade_details') }}" name="grade_details" required>
                                                    @error('grade_details')
                                                    <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                                </div>
