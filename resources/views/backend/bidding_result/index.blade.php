                ...
                <div class="card-header">
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-6 text-end">
                            @can('bidding-result.create')
                                <a href="{{ route('admin.bidding-result.create') }}" class="btn btn-primary">
                ...
                <div class="card-body">
                    <div id="buttons-datatables_wrapper" class="dataTables_wrapper dt-bootstrap5 no-footer">
                        <table id="buttons-datatables" class="display table table-bordered dataTable no-footer"
                            ...
                            <tbody>
                            @forelse ($bidding_results as $data)
                                <tr>
                                    <td>{{ $loop->iteration }}</td>

                                    <td>{{ $data->outcomes??''  }}</td>
                                    <td>{{ $data->outcomes_status??''  }}</td>
                                    <td>
                                        @if($data->deleted_at)
                                        ...
                                        <div class="dropdown d-inline-block">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end" style="">
                                                    ...
                                                    @can('bidding-result.destroy')
                                                        <li>
                                                            ...
                                                            <form id="delete-form-{{ $data->id }}"
                                                                  action="{{ route('admin.bidding-result.destroy', $data->id) }}"
                                                        ...
                                                        <li>
                                                            <a class="dropdown-item edit-item-btn"
                                                               href="{{ route('admin.bidding-result.restore', $data->id) }}">
                                                ...
                                                @else
                                                    ...
                                                    @can('bidding-result.edit')
                                                        <li>
                                                            <a class="dropdown-item edit-item-btn"
                                                               href="{{ route('admin.bidding-result.edit', $data->id) }}">
                                                    ...
                                                    @can('bidding-result.destroy')
                                                        <li>
                                                            ...
                                                            <form id="trash-form-{{ $data->id }}"
                                                                  action="{{ route('admin.bidding-result.trash', $data->id) }}"
                                                                  method="POST" style="display: none;">
                                                                @csrf
                                                            </form>
                                                        </li>
