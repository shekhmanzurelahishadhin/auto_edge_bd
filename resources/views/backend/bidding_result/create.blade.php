            ...
            <div class="card">
                <div class="card-header">
                    <div class="row align-items-center">
                        <div class="col-md-6">
                            <h4 class="card-title mb-0">Add New Bidding Result</h4>
                        </div>
                        <div class="col-md-6 text-end">
                            @can('bidding-result.index')
                                <a href="{{ route('admin.bidding-result.index') }}" class="btn dark-icon btn-danger"><i
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.bidding-result.store') }}" method="post" id="newForm" enctype="multipart/form-data" >
                        @csrf
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card">
                                        ...
                                        <div class="new-user-info">
                                            <div class="row">
                                                <div class="mb-3 col-md-12">
                                                    ...
                                                    <input id="outcomes" type="text"  class="form-control @error('outcomes') is-invalid @enderror"  value="{{ old('outcomes') }}" name="outcomes" required>
                                                    @error('outcomes')
                                                ...
                                                <div class="mb-3 col-md-12">
                                                    <label for="outcomes_status">{{ __('Outcomes Status') }}: <strong
                                                            class="text-danger">*</strong></label>
                                                    <input id="outcomes_status" type="text"  class="form-control @error('outcomes_status') is-invalid @enderror"  value="{{ old('outcomes_status') }}" name="outcomes_status" required>
