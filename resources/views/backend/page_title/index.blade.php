                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-6 text-end">
                            @can('volume-journal.create')
                                <a href="{{ route('admin.page-title.create') }}" class="btn btn-primary">
                                                    ...
                                                    @can('volume-journal.destroy')
                                                        <li>
                                                            ...
                                                            <form id="delete-form-{{ $data->id }}"
                                                                  action="{{ route('admin.page-title.destroy', $data->id) }}"
                                                        ...
                                                        <li>
                                                            <a class="dropdown-item edit-item-btn"
                                                               href="{{ route('admin.page-title.restore', $data->id) }}">
...
{{--                                                        <li>--}}
{{--                                                            <a class="dropdown-item edit-item-btn"--}}
{{--                                                               href="{{ route('admin.page-title.show', $data->id) }}">--}}
...
{{--                                                        <li>--}}
{{--                                                            <a class="dropdown-item edit-item-btn"--}}
{{--                                                               href="{{ route('admin.page-title.edit', $data->id) }}">--}}
                                                    ...
                                                    @can('volume-journal.destroy')
                                                        <li>
                                                            ...
                                                            <form id="trash-form-{{ $data->id }}"
                                                                  action="{{ route('admin.page-title.trash', $data->id) }}"
                                                                  method="POST" style="display: none;">
                                                                @csrf
                                                            </form>
                                                        </li>
