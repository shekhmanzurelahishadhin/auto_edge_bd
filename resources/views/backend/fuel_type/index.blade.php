                ...
                <div class="card-header">
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-6 text-end">
                            @can('fuel-type.create')
                                <a href="{{ route('admin.fuel-type.create') }}" class="btn btn-primary">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end" style="">
                                                    ...
                                                    @can('fuel-type.destroy')
                                                        <li>
                                                            ...
                                                            <form id="delete-form-{{ $data->id }}"
                                                                  action="{{ route('admin.fuel-type.destroy', $data->id) }}"
                                                        ...
                                                        <li>
                                                            <a class="dropdown-item edit-item-btn"
                                                               href="{{ route('admin.fuel-type.restore', $data->id) }}">
                                                ...
                                                @else
                                                    ...
                                                    @can('fuel-type.edit')
                                                        <li>
                                                            <a class="dropdown-item edit-item-btn"
                                                               href="{{ route('admin.fuel-type.edit', $data->id) }}">
                                                    ...
                                                    @can('fuel-type.destroy')
                                                        <li>
                                                            ...
                                                            <form id="trash-form-{{ $data->id }}"
                                                                  action="{{ route('admin.fuel-type.trash', $data->id) }}"
                                                                  method="POST" style="display: none;">
                                                                @csrf
                                                            </form>
                                                        </li>
